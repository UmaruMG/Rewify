...
echo ^|  _ \ _____      _^(_^)/ _^|_   _       ^| __ ^) _   _^(_^) ^| __^| ^| ___ _ __ 
echo ^| ^|_^) / _ \ \ /\ / / ^| ^|_^| ^| ^| ^|      ^|  _ \^| ^| ^| ^| ^| ^|/ _` ^|/ _ \ '__^|
echo ^|  _ ^<  __/\ V  V /^| ^|  _^| ^|_^| ^|      ^| ^|_^) ^| ^|_^| ^| ^| ^| ^(_^| ^|  __/ ^|   
echo ^|_^| \_\___^| \_/\_/ ^|_^|_^|  \__, ^|      ^|____/ \__,_^|_^|_^|\__,_^|\___^|_^|   
echo                           ^|___/
...
xcopy "%SOURCE_FOLDER%\rewify.js" "%TEMP_FOLDER%" /Q
